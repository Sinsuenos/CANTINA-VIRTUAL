...
export const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    nectarCabin2Body: "Welcome to The Nectar Route. Here the desert meets the sea. Emerald Strip is your entry point, a neon-lit stretch of coastline where salt air and Pacific heat blend into the night, and golden Nectar drifts through it all, the currency that unlocks real rewards.\n\nEvery wing you explore earns you Nectar, and it's yours to keep. Your count doesn't disappear. We're building toward promotions, discounts, freebies, contests, and social events tied to this world, so the more you explore now, the more ready you'll be when they drop.\n\nStart learning what's here. If there's something you're looking for and can't find it, reach out by email. <b>WE HAVE MUCH MORE THAN WHAT'S LISTED. A LINK TO OUR REPOSITORY WILL BE AVAILABLE SOON.</b>",
    ...
    'resident.xtease.desc': 'SWIPE MODE',
    ...
    'resident.datsk-trans.desc': 'Not a typical\ntransgender dating site',
    ...
    'resident.vixenplus.name': 'VIXENPLUS',
    'resident.vixenplus.desc': '9 SITES $1',
  ...
  es: {
    ...
    nectarCabin2Body: "Bienvenido a La Ruta Néctar. Aquí el desierto se encuentra con el mar. Emerald Strip es tu punto de entrada, un tramo de costa iluminado por neón donde el aire salado y el calor del Pacífico se mezclan en la noche, y el Néctar dorado flota entre todo, la moneda que desbloquea recompensas reales.\n\nCada ala que explores te gana Néctar, y es tuyo para quedártelo. Tu conteo no desaparece. Estamos construyendo hacia promociones, descuentos, regalos, concursos y eventos sociales ligados a este mundo, así que entre más explores ahora, más listo estarás cuando salgan.\n\nEmpieza a descubrir lo que hay aquí. Si buscas algo y no lo encuentras, escríbenos por correo. <b>TENEMOS MUCHO MÁS DE LO QUE ESTÁ LISTADO. PRONTO ESTARÁ DISPONIBLE UN ENLACE A NUESTRO REPOSITORIO.</b>",
    ...
    'resident.faphouse.name': 'FAPHOUSE',
    'resident.vixenplus.name': 'VIXENPLUS',
    'resident.vixenplus.desc': '9 SITIOS $1',
    'resident.manga-rpg.name': 'MANGA RPG',
    'resident.comix-harem-1.name': 'COMIX HAREM',
    'resident.comix-harem-2.name': 'COMIX HAREM',
    'resident.trans-offer.name': 'TRANS PORNSTAR HAREM',
